...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_so'])) {
    ...
    $insertSO = "INSERT INTO salesorder (SO_No, Customers name, Date, Total amount)
                 VALUES ('$so_no', '$customer_name', '$date', '$total_amount')";
    mysqli_query($con, $insertSO);
...
<div class="content-wrapper fade-in">
    <!-- SO Form Card -->
    <div class="so-form-card shadow">
        <div class="so-header">
            CREATE SALES ORDER
        </div>
        <div class="so-form">
            <form method="post" action="upload_so.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"><i class="fas fa-hashtag me-2"></i>SO No</label>
                            <input type="text" class="form-control" name="SO_no" value="<?php echo $next_so; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"><i class="fas fa-calendar me-2"></i>Date</label>
                            <input type="date" class="form-control" name="Date" value="<?php echo $current_date; ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="Customers_name" placeholder="Enter customer name" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="Total_amount" placeholder="0.00" readonly required>
                    </div>
                </div>
                
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button type="submit" class="btn btn-primary" name="submit_so">
                        <i class="fas fa-save me-2"></i>Create Sales Order
                    </button>
                </div>
            </form>
        </div>
    ...
    <!-- Optional: Additional content or cards can be added here -->
</div>
...
$(document).ready(function(){
    ...
    // Optional: Add input validation for amount field
    $('input[name="Total_amount"]').on('input', function() {
