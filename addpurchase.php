...
// Get PO_No from URL or session
if (isset($_GET['po_no'])) {
    $_SESSION['po_number'] = $_GET['po_no']; // Store in session
}
$po_number = $_SESSION['po_number'] ?? ''; // Retrieve from session
?>
...
<div class="content-wrapper fade-in">
    ...
    <div class="inventory-form-card shadow">
        ...
        <div class="inventory-form">
            <form method="POST" action="uploadpurchase.php">
                <!-- Hidden PO Number Field -->
                <input type="hidden" name="PO_No" value="<?= htmlspecialchars($po_number) ?>">
                ...
                <div class="mb-3 row">
                    <label for="Cost" class="col-sm-4 col-form-label">
                        <i class="fas fa-dollar-sign me-2"></i>Cost <span class="text-danger">*</span>
                    </label>
                    <div class="col-sm-8">
...
$(document).ready(function(){
    ...
    $('#Quantity, #Cost').on('input', function () {
        ...
        $('#Amount').val((quantity * cost).toFixed(2));
    });
