...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_po'])) {
    ...
    $insertPO = "INSERT INTO purchaseorder (`PO no`, `Suppliers name`, `Date`, `Total amount`)
                 VALUES ('$po_no', '$supplier_name', '$date', '$total_amount')";
    mysqli_query($con, $insertPO);
    ...
    <div class="po-form-card shadow">
        ...
        <div class="po-form">
            <form method="post" action="upload_po.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="form-label"><i class="fas fa-hashtag me-2"></i>PO No</label>
                            <input type="text" class="form-control" name="PO_no" value="<?php echo $next_po; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="form-group">
                    <label class="form-label"><i class="fas fa-building me-2"></i>Supplier Name</label>
                    <input type="text" class="form-control" name="Suppliers_name" placeholder="Enter supplier name" required>
                </div>
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" name="Total_amount" placeholder="0.00" readonly required>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button type="submit" class="btn btn-primary" name="submit_po">
